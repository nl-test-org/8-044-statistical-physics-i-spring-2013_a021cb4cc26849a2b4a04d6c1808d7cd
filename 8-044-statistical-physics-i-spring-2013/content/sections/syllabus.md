...
menu:
  leftnav:
    identifier: 98b4d02aad37adcbc86ed86183dbb82f
    name: Syllabus
    weight: 10
title: Syllabus
type: course
uid: 98b4d02aad37adcbc86ed86183dbb82f
...
There is no required textbook. Instead, there are recommended readings, notes selected topics, and slides. See below for a discussion of [recommended textbooks]({{< baseurl >}}/sections/syllabus#recommended_textbooks) that you may wish to consult.

Homework
--------

Problem sets are due as indicated on the [calendar]({{< baseurl >}}/sections/calendar). The homework contributes 20% toward the final grade. One of the 11 problem set grades, the lowest, will be dropped at the end of the term.
